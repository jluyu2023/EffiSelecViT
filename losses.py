    ...
    def forward(self, inputs, outputs, labels, model):
        ...
        for name, param in model.named_parameters():
            if param.requires_grad and 'head_zeta' in name:
                # print('With head_zeta data, the corresponding loss function is added')
                add_head_loss = torch.cat([add_head_loss, torch.abs(param.view(-1))])

            if param.requires_grad and 'mlp_zeta' in name:
                # print('With mlp_zeta data, the corresponding loss function is added')
        ...
        # print('The total head zeta data is:', total_head_zeta)
        # print('The total mlp zeta data is:', total_mlp_zeta)

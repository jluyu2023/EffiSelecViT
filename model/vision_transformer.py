    ...
    def forward(self, x):
        ...
        if self.mlp_search:
            if not self.finetune:
                x *= self.mlp_zeta
                # print('The learning of mlp_zeta is performed')
            else:
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.head_search:
            if not self.finetune:
                qkv *= self.head_zeta
                # print('Conduct the study of head')
            else:
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.blocks = nn.Sequential(*[
            Block(
                ...
                head_threshold=head_threshold, mlp_threshold=mlp_threshold, mlp_search=mlp_search,
                head_search=head_search, finetune=finetune)

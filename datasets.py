...
def build_dataset(is_train, args, folder_name=None):
    ...
    if args.data_set == 'CIFAR10':
        ...
        dataset_train = Flowers102(os.path.join(args.data_path, 'flowers102'), split='train', transform=transform,
                                   download=True)
        dataset_val = Flowers102(os.path.join(args.data_path, 'flowers102'), split='test', transform=transform,
                                 download=True)
        nb_classes = 102
